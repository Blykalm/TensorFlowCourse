...
print(j)
print("_______________________________________________71______________________________________________________________")

# Convert our tensor back to a numpy array
print(np.array(j))
print(type(np.array(j)))
print("_______________________________________________72______________________________________________________________")

# Convert tesor j to a numpy array
print(j.numpy(), type(j.numpy()))
print("_______________________________________________73______________________________________________________________")
...
print("_______________________________________________74______________________________________________________________")
